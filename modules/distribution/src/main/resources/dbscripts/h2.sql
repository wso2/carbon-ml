...
CONSTRAINT FK_PROJECT_WORKFLOW FOREIGN KEY(PROJECT) REFERENCES ML_PROJECT(ID) ON UPDATE CASCADE ON
DELETE CASCADE
);
...
CONSTRAINT FK_EXECUTION_MODEL FOREIGN KEY(EXECUTION) REFERENCES ML_EXECUTION(ID) ON UPDATE CASCADE ON
DELETE CASCADE
);
...
CONSTRAINT FK_WORKFLOW_EXECUTION FOREIGN KEY(WORKFLOW) REFERENCES ML_WORKFLOW(ID) ON UPDATE CASCADE
 ON DELETE CASCADE
);
