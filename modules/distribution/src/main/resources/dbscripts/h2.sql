...
CONSTRAINT FK_DATASET_SCHEMA_DATASET_VERSION FOREIGN KEY(DATASET_VERSION_ID) REFERENCES ML_DATASET_SCHEMA(DATASET_SCHEMA_ID)
ON UPDATE CASCADE ON DELETE CASCADE
);
...
SUMMARY CLOB,
CONSTRAINT FK_DATASET_SCHEMA_FEATURE_SUMMARY FOREIGN KEY(FEATURE_ID) REFERENCES ML_DATASET_SCHEMA(FEATURE_ID)
  ON UPDATE CASCADE ON DELETE CASCADE,
