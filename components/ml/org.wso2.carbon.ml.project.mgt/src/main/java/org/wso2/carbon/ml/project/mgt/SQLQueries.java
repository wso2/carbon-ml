...
public class SQLQueries {
	...
	public static final String GET_DEFAULT_FEATURE_SETTINGS =
			"SELECT FEATURE_NAME,TYPE,IMPUTE_METHOD,INCLUDE FROM ML_FEATURE_DEFAULTS WHERE DATASET_ID=?";

	public static final String INSERT_FEATURE_SETTINGS =
			"INSERT INTO ML_FEATURE_SETTINGS (WORKFLOW_ID,FEATURE_NAME,TYPE,IMPUTE_METHOD,INCLUDE) VALUES(?,?,?,?,?)";
