...
public class RandomForest implements Serializable {
     ...
     */
    public RandomForestModel train(JavaRDD<LabeledPoint> train, int noOfClasses,
            Map<Integer, Integer> categoricalFeatures, int numTrees, String featureSubsetStrategy, String impurityCriteria, int maxTreeDepth,
            int maxBins, int seed) {
        return org.apache.spark.mllib.tree.RandomForest.trainClassifier(train, noOfClasses,
                categoricalFeatures, numTrees, featureSubsetStrategy, impurityCriteria, maxTreeDepth, maxBins, seed);
    }
