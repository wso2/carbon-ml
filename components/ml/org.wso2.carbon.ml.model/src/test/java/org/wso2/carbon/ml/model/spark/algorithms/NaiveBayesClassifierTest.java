...
import org.wso2.carbon.ml.core.domain.NaiveBayesClassifier;
...
public class NaiveBayesClassifierTest {
    ...
    public void testModelTrainingAndTesting() throws Exception {
        ...
        NaiveBayesModel naiveBayesModel = naiveBayesClassifier.train(trainingData, 1.0);
        ClassClassificationAndRegressionModelSummary naiveBayesSummary = SparkModelUtils
                .getClassClassificationModelSummary(naiveBayesClassifier.test(naiveBayesModel, testingData));
        Assert.assertEquals(naiveBayesSummary.getError(), 0.3448, 0.0001);
        sc.stop();
    }
}
