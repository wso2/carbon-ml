...
public class LassoRegression implements Serializable {
     ...
     */
    public LassoModel train(JavaRDD<LabeledPoint> trainingDataset, int noOfIterations,
            double initialLearningRate, double regularizationParameter, double miniBatchFraction) {
        return LassoWithSGD.train(trainingDataset.rdd(), noOfIterations, initialLearningRate,
