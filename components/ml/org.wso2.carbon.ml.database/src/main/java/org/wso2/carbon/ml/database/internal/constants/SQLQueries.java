...
public class SQLQueries {
    ...
    public static final String GET_DATASET_ID = "SELECT DATASET_ID FROM ML_DATASET WHERE NAME = ? AND TENANT_ID = ? AND USERNAME = ?";
    ...
    public static final String GET_DATASET_VERSION_ID_FROM_MODEL = "SELECT DATASET_VERSION_ID FROM ML_VALUE_SET INNER JOIN (SELECT VALUE_SET_ID AS A FROM ML_MODEL WHERE MODEL_ID = ?) ON ML_VALUE_SET.VALUE_SET_ID = A";

    public static final String GET_DATASET_ID_FROM_DATASET_VERSION = "SELECT DATASET_ID FROM ML_DATASET_VERSION WHERE DATASET_VERSION_ID = ?";
    ...
    public static final String GET_CUSTOMIZED_FEATURES = "SELECT FEATURE_NAME,FEATURE_INDEX,FEATURE_TYPE, IMPUTE_OPTION, " +
            "INCLUSION FROM ML_FEATURE_CUSTOMIZED WHERE MODEL_ID=?";
    ...
    public static final String INSERT_MODEL = "INSERT INTO ML_MODEL(NAME, ANALYSIS_ID, VALUE_SET_ID, TENANT_ID, USERNAME, CREATED_TIME) "
    ...
    public static final String INSERT_MODEL_CONFIGURATION = "INSERT INTO ML_MODEL_CONFIGURATION(MODEL_ID, KEY, VALUE) "
            + "VALUES(?,?,?)";
    public static final String GET_A_MODEL_CONFIGURATION = "SELECT VALUE FROM ML_MODEL_CONFIGURATION WHERE MODEL_ID = ? AND KEY = ?";

    public static final String INSERT_HYPER_PARAMETER = "INSERT INTO ML_HYPER_PARAMETER(MODEL_ID, NAME, VALUE, LAST_MODIFIED_TIME) "
            + "VALUES(?,?,?, CURRENT_TIMESTAMP())";

    public static final String GET_HYPER_PARAMETERS_OF_MODEL = "SELECT NAME, VALUE FROM ML_HYPER_PARAMETER WHERE MODEL_ID=?";
    ...
    public static final String INSERT_DEFAULTS_INTO_FEATURE_CUSTOMIZED = 
            "INSERT INTO ML_FEATURE_CUSTOMIZED(MODEL_ID, TENANT_ID, FEATURE_NAME, FEATURE_INDEX, FEATURE_TYPE, IMPUTE_OPTION, INCLUSION, LAST_MODIFIED_USER, USERNAME, LAST_MODIFIED_TIME) "
            + "SELECT ?, ?, FEATURE_NAME, FEATURE_INDEX, TYPE, ?, ?, ?, ?, CURRENT_TIMESTAMP() FROM ML_FEATURE_DEFAULTS WHERE DATASET_VERSION_ID = ? ";
    ...
    public static final String GET_DATA_TYPE_OF_MODEL = "SELECT ML_DATASET.DATA_TYPE FROM ML_DATASET INNER JOIN "
            + "(SELECT ML_DATASET_VERSION.DATASET_ID as ID  FROM ML_DATASET_VERSION INNER JOIN "
            + "(SELECT ML_VALUE_SET.DATASET_VERSION_ID as DATASET_VERSION FROM ML_MODEL INNER JOIN "
            + "ML_VALUE_SET ON ML_MODEL.VALUE_SET_ID = ML_VALUE_SET.VALUE_SET_ID WHERE ML_MODEL.MODEL_ID=?) "
            + "ON DATASET_VERSION= ML_DATASET_VERSION.DATASET_VERSION_ID) ON ID = ML_DATASET.DATASET_ID";

    public static final String GET_VALUE_SET_ID_OF_MODEL = "SELECT VALUE_SET_ID FROM ML_MODEL WHERE MODEL_ID=? ";
