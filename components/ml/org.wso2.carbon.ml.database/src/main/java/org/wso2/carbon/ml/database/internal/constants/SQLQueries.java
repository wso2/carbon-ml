...
public class SQLQueries {
    ...
    public static final String UPDATE_WRANGLER_SCRIPT = "UPDATE ML_ANALYSIS SET WRANGLER_SCRIPT=? where ANALYSIS_ID=?";
    ...
    public static final String GET_DATASETVERSION_ID = "SELECT DATASET_VERSION_ID, NAME, URI, SAMPLE_POINTS FROM ML_DATASET_VERSION WHERE DATASET_SCHEMA_ID = ? AND TENANT_ID = ? AND USERNAME = ? AND VERSION = ?";

    public static final String GET_VERSIONSET_ID = "SELECT DATASET_VERSION_ID FROM ML_DATASET_VERSION WHERE NAME = ? AND TENANT_ID = ? AND USERNAME = ?";
    ...
    public static final String GET_WRANGLER_SCRIPT = "SELECT WRANGLER_SCRIPT FROM ML_ANALYSIS WHERE ANALYSIS_ID =?";
    ...
    public static final String GET_SUMMARY_STATS_OF_DATASET = "SELECT SUMMARY FROM ML_FEATURE_DEFAULTS INNER JOIN ML_FEATURE_SUMMARY "
            + "ON ML_FEATURE_DEFAULTS.FEATURE_ID = ML_FEATURE_SUMMARY.FEATURE_ID WHERE ML_FEATURE_DEFAULTS.DATASET_SCHEMA_ID = ? AND ML_FEATURE_DEFAULTS.FEATURE_NAME = ?";
    ...
    public static final String GET_FILTERED_FEATURE_NAMES_OF_DATASET = "SELECT FEATURE_NAME FROM ML_FEATURE_DEFAULTS WHERE DATASET_SCHEMA_ID = ? AND TYPE = ?";
    ...
    public static final String INSERT_MODEL_CONFIGURATION = "INSERT INTO ML_MODEL_CONFIGURATION(ANALYSIS_ID, `KEY`, VALUE) VALUES(?,?,?)";

    public static final String UPDATE_MODEL_CONFIGURATION = "UPDATE ML_MODEL_CONFIGURATION SET VALUE=? WHERE ANALYSIS_ID=? AND `KEY`=?";
    ...
    public static final String GET_EXISTING_HYPER_PARAMETER = "SELECT VALUE FROM ML_HYPER_PARAMETER WHERE ANALYSIS_ID=? AND NAME=?";

    public static final String INSERT_HYPER_PARAMETER = "INSERT INTO ML_HYPER_PARAMETER(ANALYSIS_ID, ALGORITHM_NAME, NAME, VALUE, LAST_MODIFIED_TIME) VALUES(?,?,?,?, CURRENT_TIMESTAMP())";

    public static final String UPDATE_HYPER_PARAMETER = "UPDATE ML_HYPER_PARAMETER SET ALGORITHM_NAME=?, VALUE=?, LAST_MODIFIED_TIME=CURRENT_TIMESTAMP() WHERE ANALYSIS_ID=? AND NAME=?";
    ...
    public static final String GET_ALL_ML_MODELS_OF_ANALYSIS = "SELECT MODEL_ID, ML_MODEL.ANALYSIS_ID, DATASET_VERSION_ID, CREATED_TIME, STORAGE_TYPE, STORAGE_LOCATION, ML_MODEL.NAME, STATUS, ERROR, SUMMARY " +
            "FROM ML_ANALYSIS INNER JOIN ML_MODEL ON ML_ANALYSIS.ANALYSIS_ID = ML_MODEL.ANALYSIS_ID WHERE ML_ANALYSIS.ANALYSIS_ID = ? AND ML_MODEL.TENANT_ID = ? AND ML_MODEL.USERNAME = ?";
    ...
    public static final String GET_FEATURES = "SELECT  FEATURE_INDEX ,ML_FEATURE_CUSTOMIZED.FEATURE_NAME ,INCLUSION ,FEATURE_TYPE , "
            ...
            + "ML_FEATURE_SUMMARY.DATASET_VERSION_ID = (SELECT MAX(DATASET_VERSION_ID) FROM ML_DATASET_VERSION WHERE DATASET_SCHEMA_ID = ?)"
            + "LIMIT ? OFFSET ?";
    
    public static final String GET_SAMPLE_POINTS_OF_LATEST_VERSION = "SELECT SAMPLE_POINTS FROM ML_DATASET_VERSION WHERE DATASET_VERSION_ID = "
            + "(SELECT MAX(DATASET_VERSION_ID) FROM ML_DATASET_VERSION WHERE DATASET_SCHEMA_ID = ?) AND TENANT_ID = ? AND USERNAME = ? ";
    ...
    public static final String GET_PROJECT_BY_ID = "SELECT PROJECT_ID, NAME, DESCRIPTION, DATASET_SCHEMA_ID, CREATED_TIME FROM ML_PROJECT "
            + "WHERE PROJECT_ID=? AND TENANT_ID = ? AND USERNAME = ? ";

    public static final String GET_PROJECT_MODELS = "SELECT MODEL_ID,ML_MODEL.NAME,ML_MODEL.ANALYSIS_ID,DATASET_VERSION_ID,CREATED_TIME,SUMMARY,STORAGE_TYPE,STORAGE_LOCATION,STATUS,ERROR "
            + "FROM ML_ANALYSIS INNER JOIN ML_MODEL ON ML_ANALYSIS.ANALYSIS_ID = ML_MODEL.ANALYSIS_ID WHERE ML_ANALYSIS.PROJECT_ID = ? AND ML_MODEL.TENANT_ID = ? AND ML_MODEL.USERNAME = ? AND STATUS = 'Complete'";
