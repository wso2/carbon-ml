...
public class SQLQueries {
    ...
    public static final String GET_PROJECT_MODELS = "SELECT MODEL_ID,ML_MODEL.NAME,ML_MODEL.ANALYSIS_ID,DATASET_VERSION_ID,CREATED_TIME,SUMMARY,STORAGE_TYPE,STORAGE_LOCATION,STATUS,ERROR "
            + "FROM ML_ANALYSIS INNER JOIN ML_MODEL ON ML_ANALYSIS.ANALYSIS_ID = ML_MODEL.ANALYSIS_ID WHERE PROJECT_ID = ? AND ML_MODEL.TENANT_ID = ? AND ML_MODEL.USERNAME = ? AND STATUS = 'Complete'";
