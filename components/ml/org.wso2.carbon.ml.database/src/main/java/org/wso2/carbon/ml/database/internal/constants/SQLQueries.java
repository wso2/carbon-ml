...
public class SQLQueries {
    ...
    public static final String INSERT_VALUE_SET = "INSERT INTO ML_DATASET_VERSION(DATASET_SCHEMA_ID, NAME, TENANT_ID, USERNAME, URI, SAMPLE_POINTS) "
            + "VALUES(?,?,?,?,?,?)";
    ...
    public static final String GET_DATA_TYPE_OF_MODEL = "SELECT ML_DATASET_SCHEMA.DATA_TYPE FROM ML_DATASET INNER JOIN "
            ...
            + "ON DATASET_VERSION= ML_DATASET_VERSION.DATASET_VERSION_ID) ON ID = ML_DATASET_SCHEMA.DATASET_SCHEMA_ID";
