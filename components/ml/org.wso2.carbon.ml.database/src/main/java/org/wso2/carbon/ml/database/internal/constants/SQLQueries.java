...
public class SQLQueries {
    ...
    public static final String GET_PROJECT = "SELECT PROJECT.NAME, PROJECT.DESCRIPTION, DATASET.DATASET_URL FROM " +
        "ML_PROJECT PROJECT, ML_DATASET DATASET WHERE PROJECT.PROJECT_ID = DATASET.PROJECT_ID AND PROJECT.PROJECT_ID = ?";
