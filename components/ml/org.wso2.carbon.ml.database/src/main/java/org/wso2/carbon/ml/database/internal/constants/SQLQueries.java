...
public class SQLQueries {
    ...
    public static final String INSERT_FEATURE_CUSTOMIZED = "INSERT INTO ML_FEATURE_CUSTOMIZED(MODEL_ID, TENANT_ID," +
            " FEATURE_NAME, TYPE, IMPUTE_OPTION, INCLUSION, LAST_MODIFIED_USER, LAST_MODIFIED_TIME) VALUES(?,?,?,?,?,?,?,?)";
    ...
    public static final String CREATE_PROJECT_NEW = "INSERT INTO ML_PROJECT(PROJECT_ID, NAME, DESCRIPTION, TENANT_ID," +
