...
public class SQLQueries {
    ...
    public static final String GET_ALL_VERSIONSETS_OF_DATASET = "SELECT * FROM ML_DATASET_VERSION  where " +
            "DATASET_SCHEMA_ID = ? AND TENANT_ID = ? AND USERNAME = ?";
    
    public static final String GET_VERSIONSET_USING_ID = "SELECT * FROM ML_DATASET_VERSION where DATASET_VERSION_ID " +
            "= ? AND TENANT_ID = ? AND USERNAME = ?";
    
    public static final String GET_ALL_DATASETS = "SELECT * FROM ML_DATASET_SCHEMA WHERE TENANT_ID = ? AND USERNAME = ?";
    
    public static final String GET_DATASET_USING_ID = "SELECT * FROM ML_DATASET_SCHEMA WHERE TENANT_ID = ? AND " +
            "USERNAME = ? AND DATASET_ID = ?";
