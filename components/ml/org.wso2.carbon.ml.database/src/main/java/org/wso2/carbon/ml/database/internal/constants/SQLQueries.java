...
public class SQLQueries {
    ...
    public static final String GET_FILTERED_FEATURE_NAMES = "SELECT FEATURE_NAME FROM ML_FEATURE_CUSTOMIZED WHERE ANALYSIS_ID = ? AND FEATURE_TYPE = ?";
    ...
    public static final String INSERT_MODEL = "INSERT INTO ML_MODEL(NAME, ANALYSIS_ID, DATASET_VERSION_ID, TENANT_ID, USERNAME, CREATED_TIME, STORAGE_TYPE, STORAGE_LOCATION) "
    ...
    public static final String GET_ALL_ML_MODELS_OF_ANALYSIS = "SELECT MODEL_ID, ANALYSIS_ID, DATASET_VERSION_ID, CREATED_TIME, STORAGE_TYPE, STORAGE_LOCATION, NAME FROM ML_MODEL WHERE ANALYSIS_ID = ? AND TENANT_ID = ? AND USERNAME = ? ";
