...
public class SQLQueries {
    ...
    public static final String INSERT_HYPER_PARAMETER = "MERGE INTO ML_HYPER_PARAMETER(ANALYSIS_ID, NAME, VALUE, LAST_MODIFIED_TIME) KEY(ANALYSIS_ID, NAME) VALUES(?,?,?, CURRENT_TIMESTAMP())";
