...
public class SQLQueries {
    ...
    public static final String INSERT_VALUE_SET = "INSERT INTO ML_VALUE_SET(DATASET_VERSION_ID, NAME, TENANT_ID, URI, SAMPLE_POINTS) " +
            "VALUES(?,?,?,?,?)";
    ...
    public static final String INSERT_ANALYSIS = "INSERT INTO ML_ANALYSIS(PROJECT_ID, NAME, TENANT_ID, COMMENTS) VALUES(?,?,?,?)";

    public static final String INSERT_MODEL = "INSERT INTO ML_MODEL(ANALYSIS_ID, VALUE_SET_ID, TENANT_ID, OUTPUT_MODEL, USERNAME, CREATED_TIME) " +
    ...
    public static final String INSERT_FEATURE_CUSTOMIZED = "INSERT INTO ML_FEATURE_CUSTOMIZED(MODEL_ID, TENANT_ID, FEATURE_NAME, IMPUTE_OPTION, " +
    ...
    public static final String CREATE_PROJECT_NEW = "INSERT INTO ML_PROJECT(NAME, DESCRIPTION, TENANT_ID," +
